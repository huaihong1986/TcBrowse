...
public class MainActivity extends AppCompatActivity {
    ...
    private void initWebView() {
        ...
        mHandlers.add("open");
        mProgressBarWebView.setDefaultHandler(new myHadlerCallBack());
        //回调js的方法
        mProgressBarWebView.registerHandlers(mHandlers, new JsHandler() {
            ...
            public void OnHandler(String handlerName, String responseData, CallBackFunction function) {
                ...
                if (handlerName.equals("login")) {
                    ...
                    Toast.makeText(MainActivity.this, "login"+responseData, Toast.LENGTH_SHORT).show();

                } else if (handlerName.equals("callNative")) {

                    Toast.makeText(MainActivity.this, "callNative"+responseData, Toast.LENGTH_SHORT).show();

                    function.onCallBack("我在上海");

                } else if (handlerName.equals("callJs")) {

                    Toast.makeText(MainActivity.this, "callJs"+responseData, Toast.LENGTH_SHORT).show();
        ...
        mProgressBarWebView.send("哈喽", new CallBackFunction() {
            ...
            public void onCallBack(String data) {
                ...
                Toast.makeText(MainActivity.this, "h5返回的消息："+data, Toast.LENGTH_SHORT).show();
    ...
    class myHadlerCallBack extends DefaultHandler {
        ...
        public void handler(String data, CallBackFunction function) {
            if(function != null){
                ...
                function.onCallBack("java send DefaultHandler response data");
            }
        }
    }
